...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/21 11:48:15 by conyejib          #+#    #+#             */
/*   Updated: 2023/07/21 13:11:12 by conyejib         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_menu(t_fdf *fdf)
{
	...
	mlx_string_put(mlx, win, 50, y += 35, C_TEXT, "Zoom_Out: press '-'");
	mlx_string_put(mlx, win, 50, y += 35, C_TEXT, "Zoom_In: press '+'");
	mlx_string_put(mlx, win, 50, y += 20, C_TEXT, "Move: press-Up or Down");
	...
	mlx_string_put(mlx, win, 50, y += 20, C_TEXT, "(Scaling limited to 100%)");
	mlx_string_put(mlx, win, 50, y += 35, C_TEXT, "Projection view:");
	...
	mlx_string_put(mlx, win, 50, y += 35, C_TEXT, "For Colors: press 'SPACE'");
